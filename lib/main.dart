...
import 'demo/line_chart/dual_axis.dart';
import 'demo/line_chart/filled.dart';
...
import 'demo/scrolling_chart/view_pager.dart';
        ...
        actions: <Widget>[
          PopupMenuButton<String>(
            itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
              ...
              const PopupMenuItem(child: Text('Problem Report'),value: 'B',),
              const PopupMenuItem(child: Text('Developer Website'),value: 'C',),
                ],
