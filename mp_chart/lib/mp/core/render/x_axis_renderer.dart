...
class XAxisRenderer extends AxisRenderer {
  ...
  void drawLabels(
    ...
    List<double?> positions = List.filled(_xAxis!.entryCount * 2, null);
  ...
  List<double?> mRenderGridLinesBuffer = List.filled(2, null);
  ...
  void renderGridLines(Canvas c) {
    ...
    if (mRenderGridLinesBuffer.length != axis!.entryCount * 2) {
      mRenderGridLinesBuffer = List.filled(_xAxis!.entryCount * 2, null);
    }
  ...
  List<double?> mRenderLimitLinesBuffer = List.filled(2, null);
  ...
  List<double?> _limitLineSegmentsBuffer = List.filled(4, null);
