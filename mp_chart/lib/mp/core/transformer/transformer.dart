...
class Transformer {
  ...
  List<double?> _valuePointsForGenerateTransformedValuesScatter = List.filled(1, null);
  ...
  List<double?> generateTransformedValuesScatter(
    ...
    if (_valuePointsForGenerateTransformedValuesScatter.length != count) {
      _valuePointsForGenerateTransformedValuesScatter = List.filled(count,null);
    }
  ...
  List<double?> _valuePointsForGenerateTransformedValuesBubble = List.filled(1,null);
  ...
  List<double?> _valuePointsForGenerateTransformedValuesLine = List.filled(1,null);
  ...
  List<double?> generateTransformedValuesLine(
    ...
    if (_valuePointsForGenerateTransformedValuesLine.length != count) {
      _valuePointsForGenerateTransformedValuesLine = List.filled(count, null);
    }
  ...
  List<double?> _valuePointsForGenerateTransformedValuesCandle = List.filled(1,null);
  ...
  List<double?> _ptsBuffer = List.filled(2, null);
